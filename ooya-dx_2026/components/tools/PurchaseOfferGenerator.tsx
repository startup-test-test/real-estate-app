...
interface PurchaseOfferGeneratorProps {
  /** ヘッダー・使い方セクションを表示するか */
  showHeader?: boolean;
  /** 免責事項を表示するか */
...
export default function PurchaseOfferGenerator({
  ...
  return (
    <div className={compact ? '' : ''}>
      ...
      <div className={`grid ${compact ? 'grid-cols-1' : 'lg:grid-cols-2'} gap-8`}>
        {/* 入力フォーム */}
        ...
        <div className={compact ? '' : 'lg:sticky lg:top-24 lg:self-start'}>
          <div className="bg-white rounded-2xl shadow-sm p-6 print:p-[15mm] print:shadow-none print:bg-white">
            ...
            <div
              ...
              style={{
                aspectRatio: '210 / 297',
                maxHeight: compact ? '500px' : 'calc(100vh - 200px)',
                overflow: 'auto'
              }}
            >
              {/* タイトル（PDF出力用・SEO対象外） */}

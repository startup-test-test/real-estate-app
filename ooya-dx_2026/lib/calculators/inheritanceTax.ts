...
export function calculateInheritanceTax(input: InheritanceTaxInput): InheritanceTaxResult {
  ...
  // 基礎控除以下の場合
  if (taxableEstate <= 0) {
    notes.push('遺産総額が基礎控除額以下のため、相続税は課税されません')
    notes.push('ただし、小規模宅地等の特例などを適用して基礎控除以下になる場合は申告が必要です')
...
export const INHERITANCE_TAX_QUICK_TABLE = [
  { assets: 50000000, tax: 400000 },      // 5,000万円 → 40万円
  { assets: 60000000, tax: 600000 },      // 6,000万円 → 60万円
  { assets: 70000000, tax: 1130000 },     // 7,000万円 → 113万円
  { assets: 80000000, tax: 1750000 },     // 8,000万円 → 175万円
  { assets: 100000000, tax: 3100000 },    // 1億円 → 310万円
  { assets: 150000000, tax: 7475000 },    // 1.5億円 → 747.5万円
  { assets: 200000000, tax: 13400000 },   // 2億円 → 1,340万円
  { assets: 300000000, tax: 28600000 },   // 3億円 → 2,860万円
  { assets: 500000000, tax: 63950000 },   // 5億円 → 6,395万円
]

/** 相続税早見表データ（子2人のみの場合） */
export const INHERITANCE_TAX_QUICK_TABLE_NO_SPOUSE = [
  { assets: 50000000, tax: 800000 },      // 5,000万円 → 80万円
  { assets: 60000000, tax: 1200000 },     // 6,000万円 → 120万円
  { assets: 70000000, tax: 1600000 },     // 7,000万円 → 160万円
  { assets: 80000000, tax: 2350000 },     // 8,000万円 → 235万円
  { assets: 100000000, tax: 3700000 },    // 1億円 → 370万円

...
### テストケース A: 本番価格キャンセルテスト

| 項目 | 内容 |
|------|------|
| **テスト日** | 2026-01-10 |
| **環境** | Production |
| **ユーザー** | togo@startup-marketing.co.jp |
| **プラン** | 大家DXプレミアムプラン（¥980/月） |
| **カード** | Visa •••• 4242（有効期限: 12/2028） |
| **契約状況** | 2026/01/09 に ¥980 支払い済み |
| **次回請求日** | 2026/02/08 |
| **テスト内容** | サブスクリプションキャンセル |
| **結果** | テスト中... |

**キャンセル後の確認項目**:
- [ ] Stripeダッシュボードでステータス確認
- [ ] Webhook受信確認（Vercel Logs）
- [ ] DBのSubscriptionテーブル更新確認
- [ ] UIで無料ユーザーとして表示されるか確認

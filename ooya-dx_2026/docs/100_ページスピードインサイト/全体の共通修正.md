...
- [x] ルール1: フォント最適化（15→8ウェイト、Noto Serif JP削除）
- [ ] ルール2: Next.js Image 移行完了
- [x] ルール3: 元画像ファイル最適化（22MB→4.8MB、PNG→JPEG変換）
- [x] ルール4: browserslist 見直し
- [ ] ルール5: 未使用 CSS 削減
- [ ] ルール6: 未使用 JS 分割
- [x] ルール7: GTM 遅延読み込み（既に afterInteractive 済み + Ahrefs を lazyOnload に）
- [ ] 改善後の再計測

      ...
      <div className="prose prose-gray max-w-none space-y-6">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed">
            本規約は、StartupMarketing Inc.（以下「当社」といいます）が提供する「大家DX」（以下「本サービス」といいます）の利用に関する条件を定めるものです。利用者は、本規約に同意した上で、本サービスを利用するものとします。本規約とその他の規約外における本サービスの説明等の内容とが異なる場合は、本規約が優先して適用されます。
          </p>
        </section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li className="mt-2">当社は、利用登録の申請者に以下の事由があると判断した場合、利用登録を拒否することがあります。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                ...
                <li>利用者が第22条（反社会的勢力の排除）に規定する反社会的勢力若しくは同条第1項各号のいずれかに該当することが判明した場合</li>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            <li className="mb-2">当社は、利用者が、以下の各号のいずれかの事由に該当する場合は、事前に通知又は催告することなく、投稿データを削除、若しくは非表示にし、利用者について本サービスの利用を一時的に停止し、又は利用者としての登録を抹消することができます。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                ...
                <li>その他、当社が本サービスの利用または利用者としての登録の継続を適当でないと合理的に判断した場合</li>
              </ul>
            </li>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            <li className="mb-2">当社は、利用者が以下の各号のいずれかに該当した場合、何らの通知等を要することなく、本契約を解除することができます。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                <li>本規約に違反したとき</li>
            ...
            <li>第1項又は第2項の措置により退会した利用者は、退会時に期限の利益を喪失し、直ちに、当社に対し負担する全ての債務を履行します。</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed mt-2">
            3. 当社は、利用者の行為が、第１項各号のいずれかに該当すると判断した場合、事前に通知することなく、以下の各号のいずれか又は全ての措置を講じることができます。
          </p>
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li className="mb-2">当社は、以下のいずれかに該当する場合には、本サービスの利用の全部又は一部を停止又は中断することができます。この場合において、当社は利用者に対して、できる限り事前に通知するよう努めます。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            ...
            <li className="mb-2">前３項のほか、当社は、利用者に対して、以下の各号の事項について、一切の保証をしません。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-700">
            <li className="mb-2">利用者は、現在、暴力団、暴力団員、暴力団員でなくなった時から5年を経過しない者、暴力団準構成員、暴力団関係企業、総会屋等、社会運動等標ぼうゴロ又は特殊知能暴力集団等、その他これらに準ずる者（以下総称して「反社会的勢力」といいます。）に該当しないこと、及び次の各号のいずれにも該当しないことを表明し、かつ将来にわたっても該当しないことを確約します。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
            ...
            <li className="mb-2">利用者は、自ら又は第三者を利用して次の各号のいずれにも該当する行為を行わないことを確約します。
              <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
                <li>暴力的な要求行為</li>

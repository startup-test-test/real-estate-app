...
export default function ProfilePage() {
  ...
  const mediaAppearances = [
    { year: '2024年1月', content: 'フジテレビ「イット！」にて、不動産賃貸業の空き家再生についてインタビュー', link: 'https://startup-marketing.co.jp/wp-content/uploads/2024/05/akiya.png' },

...
const tocItems: TocItem[] = [
  { id: 'quick-table', title: '譲渡所得税早見表', level: 2 },
 ...
 * 譲渡所得税シミュレーター本体
 */
function CapitalGainsTaxSimulator() {
  // 入力状態（万円単位）
    ...
    <>
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-100 rounded-lg p-4 mb-4">
          ...
          <p className="font-mono text-gray-800 text-center text-xs sm:text-sm mt-2">
            課税譲渡所得 = 譲渡所得 − 特別控除
          </p>
          <p className="font-mono text-gray-800 text-center text-xs sm:text-sm mt-2">
            税額 = 課税譲渡所得 × 税率
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">居住用財産の3,000万円特別控除</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">10年超所有の軽減税率</h3>
            <p className="text-xs sm:text-sm text-gray-700 mb-2">

...
// シミュレーター部分
// =================================================================
function SaleProceedsSimulator() {
  // 入力状態（万円単位）
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 sm:p-6 shadow-sm">
        ...
        <div className="bg-white rounded-lg p-3 sm:p-4 mb-4 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="isResidential" className="text-xs sm:text-sm text-gray-700">
        ...
        <div className="bg-white rounded-lg p-3 sm:p-4">
          <div className="grid grid-cols-2 gap-y-3 text-sm sm:text-base">
            ...
            <span className="text-right text-base sm:text-lg font-medium text-red-600">
            ...
            <span className="text-right text-base sm:text-lg font-medium border-t pt-3">
              {formatManYen(result.preTaxProceeds)}
            </span>

            <span className="text-gray-600">所有期間</span>
            <span className="text-right text-xs sm:text-sm text-gray-600">{ownershipLabel}</span>
            ...
            <span className={`text-right text-xl sm:text-2xl font-bold border-t-2 border-blue-300 pt-4 mt-2 ${result.netProceeds >= 0 ? 'text-blue-700' : 'text-red-700'}`}>
              {result.netProceeds >= 0 ? '' : '-'}約{formatManYen(Math.abs(result.netProceeds))}
            </span>

            {result.salePrice > 0 && (
              <>
                <span className="text-xs sm:text-sm text-gray-500">売却価格に対する手取り率</span>
                <span className="text-right text-xs sm:text-sm text-gray-500">
...
// 追加コンテンツ部分
// =================================================================
function SaleProceedsAdditionalContent({ relatedGlossary }: { relatedGlossary: GlossaryItem[] }) {
  return (
    <>
      {/* 早見表 */}
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
            <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">仲介手数料</h3>
          ...
          <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
            <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">その他の譲渡費用</h3>
            <p className="text-xs sm:text-sm text-gray-700 mb-2">
          ...
          <div className="border border-gray-200 rounded-lg p-3 sm:p-4">
            <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">ローン関連費用</h3>
            <p className="text-xs sm:text-sm text-gray-700 mb-2">
      ...
      <section className="mb-12">
          ...
          <table className="w-full text-xs sm:text-sm border-collapse">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 px-2 sm:px-3 py-2 text-left">所有期間</th>
                <th className="border border-gray-300 px-2 sm:px-3 py-2 text-center">税率（合計）</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">5年以下（短期）</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2 text-center font-semibold">39.63%</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">5年超（長期）</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2 text-center font-semibold">20.315%</td>
              </tr>
              <tr className="bg-blue-50">
                <td className="border border-gray-300 px-2 sm:px-3 py-2">10年超（軽減・6,000万以下）</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2 text-center font-semibold text-blue-700">14.21%</td>
              </tr>
            </tbody>
          </table>
          <p className="text-xs text-gray-500 mt-2">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
          <p className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">関連シミュレーター</p>
          <p className="text-xs sm:text-sm text-gray-700 mb-2">
...
export function SaleProceedsCalculator({ relatedGlossary = [] }: SaleProceedsCalculatorProps) {
  return (
    <ToolPageLayout
      ...
      additionalContent={<SaleProceedsAdditionalContent relatedGlossary={relatedGlossary} />}
    >

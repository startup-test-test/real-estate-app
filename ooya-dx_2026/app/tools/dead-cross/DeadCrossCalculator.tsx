            ...
            {result.deadCrossYear !== null ? (
              <div className="bg-amber-50 border-2 border-amber-300 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-bold text-amber-800 text-sm sm:text-base">デッドクロス発生予測</span>
                </div>
                <p className="text-2xl sm:text-3xl font-bold text-amber-700 mb-1">
              ...
              <div className="bg-green-50 border-2 border-green-300 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-bold text-green-800 text-sm sm:text-base">デッドクロスは発生しません</span>
                </div>

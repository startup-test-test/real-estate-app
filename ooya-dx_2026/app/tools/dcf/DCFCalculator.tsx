  ...
  return (
    <>
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-3 sm:p-6 shadow-sm">
        ...
        <div className="bg-white rounded-lg p-3 sm:p-4 mb-4 space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                min="0"
                max="20"
                className="flex-1 px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
                placeholder="例：4.0"
              />
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-sm sm:text-base"
            >
        ...
        {result && (
          <div className="bg-white rounded-lg p-3 sm:p-4">
            ...
            {/* 内訳 */}
            <div className="grid grid-cols-2 gap-y-3 text-sm sm:text-base border-t pt-4">
      ...
      <section className="mt-8 sm:mt-12 mb-8 sm:mb-12">
        <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">DCF評価額の早見表</h2>
  ...
  return (
    <>
      ...
      <section className="mb-8 sm:mb-12">
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-lg p-3 sm:p-4 mb-4 font-mono text-xs sm:text-sm">
        ...
        <div className="space-y-3 mb-6">
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <p className="font-medium text-gray-800 mb-1 text-sm sm:text-base">割引率（Discount Rate）</p>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <p className="font-medium text-gray-800 mb-1 text-sm sm:text-base">最終還元利回り（Terminal Cap Rate）</p>
            <p className="text-xs sm:text-sm text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-3">
            <p className="font-medium text-gray-800 mb-1 text-sm sm:text-base">保有期間</p>
            <p className="text-xs sm:text-sm text-gray-600">
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full text-xs sm:text-sm border-collapse">
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 px-2 sm:px-3 py-2 text-left">比較項目</th>
                <th className="border border-gray-300 px-2 sm:px-3 py-2 text-left">直接還元法</th>
                <th className="border border-gray-300 px-2 sm:px-3 py-2 text-left">DCF法</th>
              </tr>
            </thead>
            <tbody>
              <tr className="bg-white">
                <td className="border border-gray-300 px-2 sm:px-3 py-2">計算構造</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">NOI ÷ 還元利回り</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">各期PV + 復帰価格PV</td>
              </tr>
              <tr className="bg-gray-50">
                <td className="border border-gray-300 px-2 sm:px-3 py-2">前提</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">収益が安定的</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">収益変動を織り込む</td>
              </tr>
              <tr className="bg-white">
                <td className="border border-gray-300 px-2 sm:px-3 py-2">適した物件</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">安定稼働物件</td>
                <td className="border border-gray-300 px-2 sm:px-3 py-2">開発案件、空室あり物件</td>
              </tr>
            </tbody>
          </table>
        </div>

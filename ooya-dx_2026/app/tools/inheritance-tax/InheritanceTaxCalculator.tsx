...
// シミュレーター本体
function InheritanceTaxSimulator() {
  // 入力状態（万円単位で入力を受け付ける）
      ...
      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-3 sm:p-6 shadow-sm">
        ...
        <div className="bg-white rounded-lg p-3 sm:p-4">
          <div className="grid grid-cols-2 gap-y-3 text-sm sm:text-base">
            ...
            <span className="text-right text-base sm:text-lg font-medium">{(result.totalAssets / 10000).toLocaleString('ja-JP')}万円</span>

            {result.debts > 0 && (
              <>
                <span className="text-gray-600">債務・葬式費用</span>
                <span className="text-right text-base sm:text-lg font-medium text-red-600">-{(result.debts / 10000).toLocaleString('ja-JP')}万円</span>
              </>
            )}


            <span className="text-gray-600 border-t pt-3">正味の遺産額</span>
            <span className="text-right text-base sm:text-lg font-medium border-t pt-3">{(result.netAssets / 10000).toLocaleString('ja-JP')}万円</span>

            <span className="text-gray-600">法定相続人</span>
            <span className="text-right text-base sm:text-lg font-medium">{result.legalHeirCount}人</span>

            <span className="text-gray-600">基礎控除額</span>
            <span className="text-right text-base sm:text-lg font-medium text-red-600">-{(result.basicDeduction / 10000).toLocaleString('ja-JP')}万円</span>

            <span className="text-gray-600 border-t pt-3">課税遺産総額</span>
            <span className="text-right text-base sm:text-lg font-medium border-t pt-3">{(result.taxableEstate / 10000).toLocaleString('ja-JP')}万円</span>
  ...
  return (
    <>
      ...
      <section className="mb-8 sm:mb-12">
        ...
        <ol className="list-decimal list-inside text-sm sm:text-base text-gray-700 space-y-2 mb-4">
          ...
          <table className="w-full text-xs sm:text-sm border-collapse">
            ...
            <thead>
              <tr className="bg-gray-100">
                <th className="border border-gray-300 px-2 sm:px-3 py-2 text-left">法定相続分に応ずる取得金額</th>
            ...
            <tbody>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">1,000万円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">10%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">-</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">3,000万円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">15%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">50万円</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">5,000万円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">20%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">200万円</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">1億円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">30%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">700万円</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">2億円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">40%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">1,700万円</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">3億円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">45%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">2,700万円</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">6億円以下</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">50%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">4,200万円</td></tr>
              <tr><td className="border border-gray-300 px-2 sm:px-3 py-2">6億円超</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">55%</td><td className="border border-gray-300 px-2 sm:px-3 py-2 text-center">7,200万円</td></tr>
            </tbody>
          </table>
        </div>
      </section>

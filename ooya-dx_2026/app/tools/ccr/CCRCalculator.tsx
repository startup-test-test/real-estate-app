...
const tocItems: TocItem[] = [
  { id: 'quick-table', title: 'CCRの早見表', level: 2 },
...
function CCRSimulator() {
  ...
  const [opexRate, setOpexRate] = useState<number>(20)
  ...
  // 計算値
  const equityInMan = downPaymentInMan + purchaseCostsInMan
  const loanAmountInMan = propertyPriceInMan - downPaymentInMan
          ...
          <div className="mt-4 pt-4 border-t border-gray-200">
            ...
            <div className="text-xs sm:text-sm text-gray-700 font-mono space-y-1">
              ...
              <p className="text-xs text-gray-500 mt-2">
                = {result.annualBTCF.toLocaleString()}万円 / {(downPaymentInMan + purchaseCostsInMan).toLocaleString()}万円 × 100
              </p>
  ...
  return (
    <>
      ...
      <section className="mb-12">
        ...
        <p className="text-xs sm:text-sm text-gray-600 mb-4">自己資金1,000万円の場合の年間キャッシュフローとCCR</p>

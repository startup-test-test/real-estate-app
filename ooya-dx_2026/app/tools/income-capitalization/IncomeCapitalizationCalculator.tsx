...
// シミュレーター部分
// =================================================================
function IncomeCapitalizationSimulator() {
  // 入力状態（万円単位）
...
// 追加コンテンツ部分
// =================================================================
function IncomeCapitalizationAdditionalContent({ relatedGlossary }: { relatedGlossary: GlossaryItem[] }) {
  return (
    <>
      {/* 早見表 */}
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-100 rounded-lg p-3 sm:p-4 mb-4">
          <p className="font-mono text-gray-800 text-center text-base sm:text-lg">
            収益価格 = NOI ÷ キャップレート
          </p>
        ...
        <div className="bg-gray-50 rounded-lg p-3 sm:p-4 mb-4 space-y-3">
          <div>
            <p className="font-semibold text-gray-800 text-sm sm:text-base">1. GPI（総潜在収入）</p>
            <p className="text-xs sm:text-sm text-gray-600 ml-4">= 満室時の年間賃料収入（駐車場・共益費含む）</p>
          </div>
          <div>
            <p className="font-semibold text-gray-800 text-sm sm:text-base">2. EGI（実効総収入）</p>
            <p className="text-xs sm:text-sm text-gray-600 ml-4">= GPI - 空室損失 - 滞納損失</p>
          </div>
          <div>
            <p className="font-semibold text-gray-800 text-sm sm:text-base">3. NOI（純営業収益）</p>
            <p className="text-xs sm:text-sm text-gray-600 ml-4">= EGI - 運営費用（OPEX）</p>
          </div>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-3 sm:p-4 mb-4">
          <p className="font-semibold text-gray-800 mb-2 text-sm sm:text-base">例：年間賃料1,200万円、空室率5%、運営費率20%、キャップレート5%の場合</p>
...
export function IncomeCapitalizationCalculator({ relatedGlossary = [] }: Props) {
  return (
    <ToolPageLayout
      ...
      additionalContent={<IncomeCapitalizationAdditionalContent relatedGlossary={relatedGlossary} />}
    >

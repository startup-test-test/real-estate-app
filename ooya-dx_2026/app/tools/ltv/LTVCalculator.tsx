    ...
    <>
      ...
      <section className="mb-12">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <h4 className="font-medium text-gray-900 mb-3 text-sm sm:text-base">目標LTVから借入額を計算</h4>
        ...
        {/* 逆算ツール2 */}
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <h4 className="font-medium text-gray-900 mb-3 text-sm sm:text-base">自己資金からLTVを計算</h4>
          <div className="space-y-3">
            <NumberInput
              label="物件価格"

          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="flex-1 space-y-8 text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <p>
                  「大家DX」は、私自身が大家として「本当に欲しかった」機能を全て詰め込んだツールです。物件住所を入力するだけで、AIが類似物件の取引事例を自動収集・分析し、周辺相場を瞬時に把握。さらに、精緻な収益シミュレーションで35年間のキャッシュフローと投資指標を一括計算。市場分析から収益予測まで、賃貸経営の意思決定に必要な全てを、このツール一つで完結できます。
                </p>
              </div>
            </div>
          </div>

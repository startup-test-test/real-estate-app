          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div className="flex-1 space-y-8 text-gray-700 leading-relaxed">
              ...
              <div>
                ...
                <p className="mb-4">
                  この経験から、精緻なシミュレーションの重要性を痛感し、様々なツールを探し始めました。しかし、既存のスプレッドシートで計算するのは大変で、クラウドツールも中々いいのに出会えなかったです。
                </p>
              ...
              <div>
                ...
                <p className="mb-4">
                  自分が本当に欲しいと思える、日本の不動産投資の現実に即したシミュレーションツールは、世の中にありませんでした。
                </p>
                <p className="text-lg font-bold text-gray-800 mb-4">
                  それなら、自分で創るしかない。
                </p>
                <p>
                  「大家DX」は、私自身が大家として「本当に欲しかった」機能と知識を全て詰め込んだ、実践的な不動産投資シミュレーションツールです。
                </p>
              </div>
            </div>
          </div>

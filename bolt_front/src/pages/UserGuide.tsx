...
const UserGuide: React.FC = () => {
  ...
  const steps = [
    {
      id: 1,
      title: '物件情報の入力',
      description: '購入を検討している物件の基本情報を入力します',
      icon: Building,
      details: [
        '物件名・住所の入力',
        '取得価格・建物価格の設定',
  ...
  const features = [
    ...
    {
      icon: Target,
      title: '収益分析サポート（参考情報提供）',
      description: 'IRR、CCR、DSCRなどの収益指標を自動計算し、客観的な分析情報を提供します。'
    },
    {
      icon: Shield,
      title: 'リスク分析',
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              ...
              <div className="divide-y divide-gray-200">
                {[
                  {
                    question: '大家DXとは何ですか？',
                    answer: '大家DXは、不動産賃貸経営の収益シミュレーションツールです。物件情報を入力することで、キャッシュフローや収益指標を計算し、経営判断の参考情報を提供します。※本サービスは不動産賃貸経営の教育・参考目的のシミュレーションツールです。提供する情報・分析結果は参考情報であり、将来の経営成果や事業の成功を保証するものではありません。実際の経営判断・投資判断は、宅地建物取引士・税理士等の専門家にご相談の上、必ずご自身の責任において行ってください。当社は金融商品取引業および宅地建物取引業の登録を受けておらず、個別の投資助言・取引仲介は行っておりません。'
                  },
                  {
                ...
                {[
                  {
                    ...
                    answer: '無料プランでは無制限で収益シミュレーション機能をご利用いただけます。基本的な収益指標の確認とPDFレポート出力も可能です。現在、有料プランの新規募集は停止しており、すべてのユーザー様に無料プランをご提供しております。'
                  },
                  {

      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">
            大家DXの使い方とよくある質問をまとめました。不動産賃貸経営の収益シミュレーションで、経営判断の参考情報を提供します。
          </p>
        </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              ...
              <div className="divide-y divide-gray-200">
                {[
                  {
                    question: '大家DXとは何ですか？',
                    answer: '大家DXは、不動産賃貸経営の収益シミュレーションツールです。物件情報を入力することで、キャッシュフローや投資指標を計算し、経営判断の参考情報を提供します。※本サービスは不動産賃貸経営の教育・参考目的のシミュレーションツールです。提供する情報・分析結果は参考情報であり、将来の経営成果や事業の成功を保証するものではありません。実際の経営判断・投資判断は、宅地建物取引士・税理士等の専門家にご相談の上、必ずご自身の責任において行ってください。当社は金融商品取引業および宅地建物取引業の登録を受けておらず、個別の投資助言・取引仲介は行っておりません。'
                  },
                  {
                  ...
                  {
                    question: '初心者でも使えますか？',
                    answer: 'はい。直感的なインターフェースと詳細なガイドにより、不動産賃貸経営初心者の方でも簡単にご利用いただけます。また、用語解説や投資指標の説明も充実しています。'
                  }
                ].map((item, index) => {
                ...
                {[
                  {
                    ...
                    answer: '入力された物件情報、収益情報、借入条件等を基に、IRR（内部収益率）、CCR（自己資金収益率）、キャッシュフロー等の投資指標を算出します。これらは一般的な不動産賃貸経営の計算式に基づく参考値です。'
                  },
                  {
                    question: 'シミュレーション結果の精度はどの程度ですか？',
                    answer: '過去の実績データとの照合により、高い精度を実現していますが、市場環境の変化により実際の結果と異なる場合があります。経営判断の参考としてご活用ください。'
                  },
                  {
                    question: 'シミュレーションの限界はありますか？',
                    answer: 'シミュレーションは入力値に基づく机上の計算であり、実際の市場動向、物件の個別事情、突発的な事象等は反映されません。あくまで参考情報としてご利用いただき、実際の経営判断・投資判断は宅地建物取引士・税理士等の専門家にご相談ください。'
                  }
                ].map((item, index) => {
                ...
                {[
                  {
                    ...
                    answer: '無料プランでは月5件までのシミュレーション、基本的な分析機能をご利用いただけます。有料プランでは無制限のシミュレーション、詳細な市場分析、PDF出力、優先サポートなどの機能が追加されます。'
                  },
                  {

          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-700 space-y-4">
                <p>
                  本サービスは、不動産経営の学習および参考情報の提供を目的としたシミュレーションツールです。本サービス上で提供する情報および分析・シミュレーション結果は、お客様の経営判断を補助するための参考情報であり、特定の取引を推奨するものではなく、また将来の事業の成功や収益性を保証するものではありません。
                </p>
                <p>
                  実際の事業判断、投資判断、その他一切の意思決定は、必ずご自身の責任と判断において行ってください。本サービスの利用に起因して、利用者または第三者に何らかの損害が生じた場合であっても、当社は一切の責任を負いかねます。
                </p>
                <p>
                  当社は金融商品取引業の登録を受けておらず、金融商品取引法に定められる「投資助言・代理業」を行うものではありません。したがって、個別の投資助言は一切行っておりません。
                </p>
                <p>
                  また、本サービスは宅地建物取引業務を代替するものではありません。物件の契約や税務に関する実務的なご相談は、必ず宅地建物取引士、税理士、弁護士等の有資格専門家にご自身で行ってください。
                </p>
              </div>
            </section>
